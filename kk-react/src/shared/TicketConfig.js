...
export const EXCLUDE_CANCLE_CLOSE = [TICKET_STATUS_MAP.NEW, TICKET_STATUS_MAP.REOPEN, TICKET_STATUS_MAP.ASSESS,
  TICKET_STATUS_MAP.REJECTED, TICKET_STATUS_MAP.ACCEPTED, TICKET_STATUS_MAP.SOLVING, TICKET_STATUS_MAP.SOLVED
];

// 个人工作台我工单tab
export const ADVISE_TABS = {
  REPORT: 2,
  RESPONSE: 1,
};
...
export const ticketQueryMoreList = [
